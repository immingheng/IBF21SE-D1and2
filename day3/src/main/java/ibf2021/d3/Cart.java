...
public class Cart {
    ...
    protected String prompt = ""; // prompt refers to user input read from console
    protected List<String> cartItem = new ArrayList<String>();    //create an array list for the cart
    protected String[] promptList = new String[0]; // promptList is an array of strings filled by splitting delimiter ","
